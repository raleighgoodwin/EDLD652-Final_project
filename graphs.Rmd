...
# or you could do it like this if you don't want any words
...
data %>% 
  ...
  labs(title = "General conspiracy belief across political ideology and education",
...
data %>% 
  ...
  scale_fill_viridis_c(option = "magma")+
  labs(title = "Vaccination conspiracy belief across political ideology and education",
       x = "Political ideology",
       y = "Degree of education",
       fill = "Vaccination\nconspiracy\nbelief level")+
  theme_minimal()+
